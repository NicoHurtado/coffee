    ...
    <div className="p-6 lg:p-8 space-y-6">
      <div className="flex items-end justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Distribución de activos, gastos por categoría y flujo mensual.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-2xl border bg-card p-5">
          <div className="text-xs uppercase tracking-wide text-muted-foreground">Activos totales</div>
        ...
        <div className="rounded-2xl border bg-card p-5">
          <div className="text-xs uppercase tracking-wide text-muted-foreground">Gastos del período</div>
          <div className="text-2xl font-bold tabular-nums text-red-500 mt-1">
            -{formatMoney(totalExpenses, currency)}
          </div>
        </div>
        <div className="rounded-2xl border bg-card p-5">
          <div className="text-xs uppercase tracking-wide text-muted-foreground">Flujo neto</div>
          <div
            className={cn(
              "text-2xl font-bold tabular-nums mt-1",
              netFlow >= 0 ? "text-emerald-600" : "text-red-500",
            )}
          >
            {netFlow >= 0 ? "+" : "-"}
      ...
      <div className="grid grid-cols-12 gap-6">
        {/* Distribution donut */}
        <div className="col-span-12 xl:col-span-5 rounded-2xl border bg-card p-5">
          <h2 className="text-sm font-semibold mb-1">Distribución de activos</h2>
        ...
        {/* Categories bar */}
        <div className="col-span-12 xl:col-span-7 rounded-2xl border bg-card p-5">
          <h2 className="text-sm font-semibold mb-1">Gastos por categoría</h2>
          <p className="text-xs text-muted-foreground mb-4">
        ...
        {/* Monthly income vs expense */}
        <div className="col-span-12 rounded-2xl border bg-card p-5">
          <h2 className="text-sm font-semibold mb-1">Ingresos vs Gastos por mes</h2>
          <p className="text-xs text-muted-foreground mb-4">
          ...
          <ChartContainer config={monthlyConfig} className="h-72 w-full">
            <BarChart data={monthly}>
              ...
              <YAxis tickLine={false} axisLine={false} tick={{ fontSize: 11 }} width={80} />
              <ChartTooltip
                content={
                  <ChartTooltipContent
                    formatter={(v) => formatMoney(Number(v), currency)}
