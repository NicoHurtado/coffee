// Recetas de vidrio de glasscn (MIT) — https://glasscn-components.vercel.app
// Instaladas con `npx shadcn add @glasscn/glass-variants`. app/globals.css
// refleja `frosted` en .surface y `liquid` en .glass, con el relleno más
// alto de lo que trae la librería: con 10% de opacidad las cifras dejan de
// leerse sobre el lienzo. Se conserva aquí el original como referencia y
// para aplicarlo por className donde haga falta.
